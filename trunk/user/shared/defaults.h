...
#define DEF_WLAN_2G_SSID	BOARD_PID "WiFi_20M_%s"
#define DEF_WLAN_5G_SSID	BOARD_PID "WiFi_20M_5G_%s"
#define DEF_WLAN_2G_GSSID	BOARD_PID "WiFi_20M_GUEST_%s"
#define DEF_WLAN_5G_GSSID	BOARD_PID "WiFi_20M_GUEST_5G_%s"
